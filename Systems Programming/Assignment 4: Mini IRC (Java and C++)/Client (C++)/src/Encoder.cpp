...
std::string Encoder::fromAsciiToUtf8(const std::string& source) throw(boost::locale::conv::conversion_error){
	return boost::locale::conv::to_utf<char>(source, "UTF-8", boost::locale::conv::stop);
}
